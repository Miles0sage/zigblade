/**
 * ZigBlade 5x7 Pixel Font — ASCII 32–126
 *
 * Each character is 5 bytes (5 columns).  Bit 0 = top row, bit 6 = bottom row.
 * This is the standard column-major format used by SSD1306/SH1106 displays.
 *
 * Character cell is 6x8 pixels (5 data + 1 space, 7 data + 1 space).
 */

#ifndef ZIGBLADE_FONT5X7_H
#define ZIGBLADE_FONT5X7_H
...
#define FONT_CELL_WIDTH   6   /* 5 + 1 pixel gap */
#define FONT_CELL_HEIGHT  8   /* 7 + 1 pixel gap */
